...
_Back up your vault before syncing. AI tool operations may modify files, so permission confirmation is recommended. For third-party OpenAI-compatible endpoints, verify the model capabilities you plan to use. This is a community edition derived from the upstream project, not an official Nutstore release._
